...
import componentCss from './CheckboxScss.module.scss';
 ...
 * @public
 */
const CheckboxScssDecorator = compose(
 ...
 * @public
 */
const CheckboxScss = CheckboxScssDecorator(CheckboxScssBase);

export default CheckboxScss;
export {
	CheckboxScss,
	CheckboxScssBase,
	CheckboxScssDecorator
};
