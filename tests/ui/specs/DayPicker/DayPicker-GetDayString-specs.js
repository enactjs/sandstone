...
describe('DayPicker', function () {
	...
	describe('LTR', function () {
		...
		it('should display proper selected day string [QWTC-2427]', async function () {
			...
			expect(await dayPicker.item(2).getAttribute('aria-checked')).to.equal('true');
			await dayPicker.item(3).click();
			expect(await dayPicker.item(3).getAttribute('aria-checked')).to.equal('true');
			await dayPicker.item(4).click();
			expect(await dayPicker.item(4).getAttribute('aria-checked')).to.equal('true');
			await dayPicker.item(5).click();
			expect(await dayPicker.item(5).getAttribute('aria-checked')).to.equal('true');
			...
			expect(await dayPicker.extractSelectedDayString()).to.equal('Every Weekday');

			// Step 4-1: Click on Saturday, Sunday.
			// Step 4-1 Verify: All 7 days are selected.
			await dayPicker.item(0).click();
			expect(await dayPicker.item(0).getAttribute('aria-checked')).to.equal('true');
			await dayPicker.item(6).click();
			expect(await dayPicker.item(6).getAttribute('aria-checked')).to.equal('true');
			...
			expect(await dayPicker.extractSelectedDayString()).to.equal('Every Day');
			...
			await dayPicker.item(2).click();
			expect(await dayPicker.item(2).getAttribute('aria-checked')).to.equal('false');
			await dayPicker.item(3).click();
			expect(await dayPicker.item(3).getAttribute('aria-checked')).to.equal('false');
			await dayPicker.item(4).click();
			expect(await dayPicker.item(4).getAttribute('aria-checked')).to.equal('false');
			await dayPicker.item(5).click();
			expect(await dayPicker.item(5).getAttribute('aria-checked')).to.equal('false');
