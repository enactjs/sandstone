...
describe('qa-VirtualGridList', function () {
	...
	it('should spotlight is on the bottom/top in same column via page up/down key with nativescroll mode[QWT-2349]', function () {
	...
	it('should spotlight is on the bottom/top in same column via page up/down key with translatescroll mode[QWT-2355]', function () {
