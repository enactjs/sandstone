...
describe('VirtualList', function () {
	...
	describe('LTR locale', function () {
		...
		it('should Items Animate via 5-way Up and Down on Last Item on the page - vertical [QWTC-2060]', async function () {
			...
			await expectFocusedItem(Number((bottomId.slice(4))));
			...
			await expectFocusedItem(Number((await Page.topVisibleItemId()).slice(4)));
			await expectFocusedItem(0);  // to double check it is really top item
		});
