...
const app = (props) => <div {...props}>
	<WizardPanel
		...
		title="WizardPanel"
	>
		<View id="view1" footer="Footer in View 1" subtitle="A subtitle for View 1" title="WizardPanel View 1">
			<Scroller>
		...
		<View id="view2" subtitle="A subtitle for View 2" title="WizardPanel View 2">
		...
		<View id="view3" footer="Footer in View 3" subtitle="A subtitle for View 3" title="WizardPanel View 3">
		...
		<View id="view4" footer="Footer in View 4" subtitle="A subtitle for View 4" title="WizardPanel View 4">
			<BodyText>A simple view</BodyText>
			<buttons>
				<Button>OK</Button>
				<Button>Cancel</Button>
