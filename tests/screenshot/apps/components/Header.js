...
const LtrTests = [
	...
	...withProps({type: 'walkthrough', centered: true}, baseTests),
	...
	...withProps({type: 'walkthrough', centered: true, showInput: true, headerInput: dropIn.input}, baseTests),
	...
	// Walkthrough Type Slots
	...withProps({type: 'walkthrough', centered: true, slotAbove: dropIn.steps}, baseTests),
	...withProps({type: 'walkthrough', centered: true, slotBefore: dropIn.backButton, slotAfter: dropIn.nextButton}, baseTests),
	...withProps({type: 'walkthrough', centered: true, slotAbove: dropIn.steps, slotBefore: dropIn.backButton, slotAfter: dropIn.nextButton}, baseTests)
];
