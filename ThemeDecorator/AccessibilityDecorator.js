...
const AccessibilityDecorator = hoc((config, Wrapped) => {
	const Accessibility = (props) => {
		const accessibilityProps = setDefaultProps(props, accessibilityDefaultProps);
		const {className, focusRing, highContrast, skinVariants, textSize, ...rest} = accessibilityProps;
