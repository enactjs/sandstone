...
const PageViewsBase = kind({
	...
	computed: {
		...
		className: ({fullContents, pageIndicatorPosition, pageIndicatorType, styler}) => {
			return styler.append({fullContents}, pageIndicatorType, `indicator${cap(pageIndicatorPosition)}`);
		},
