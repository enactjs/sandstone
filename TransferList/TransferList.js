...
const TransferListBase = kind({
	...
	render: ({css, firstList, height: defaultHeight, itemSize: defaultItemSize, moveOnSpotlight, noMultipleDrag, renderItem, secondList, setFirstList, setSecondList, showSelectionOrder}) => {
