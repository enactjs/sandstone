...
import {WizardPanels} from '@enact/sandstone/Panels';
...
storiesOf('Sandstone', module)
	.add(
		...
		() => (
			...
			>
				<WizardPanels.View subtitle="Panel 1" title="Panel 1">
					<Scroller>
				...
				<WizardPanels.View footer="Panel 2" subtitle="Panel 2" title="Panel 2">
				...
				<WizardPanels.View footer="Panel 3" subtitle="Panel 3" title="Panel 3">
				...
				<WizardPanels.View footer="Panel 4" subtitle="Panel 4" title="Panel 4">
