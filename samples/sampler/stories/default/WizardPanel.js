...
storiesOf('Sandstone', module)
	.add(
		...
		() => (
			...
			>
				<WizardPanel.View footer="Footer in View 1" subtitle="A subtitle for View 1" title="WizardPanel View 1">
					<Scroller>
				...
				<WizardPanel.View subtitle="A subtitle for View 2" title="WizardPanel View 2">
				...
				<WizardPanel.View footer="Footer in View 3" subtitle="A subtitle for View 3" title="WizardPanel View 3">
					<Item>
						<slotBefore>
				...
				<WizardPanel.View footer="Footer in View 4" subtitle="A subtitle for View 4" title="WizardPanel View 4">
					<Icon>resumeplay</Icon>
