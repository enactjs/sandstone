...
const handleWillTransition = () => {
	document.activeElement.blur(); // it does not work because blur is late than next step button render.
};
	...
	.add(
		...
		() => (
			<WizardPanels
				...
				onTransition={handleWillTransition}
			...
			>
				<WizardPanels.Panel
					...
					nextButton={<Button key="next1"> next1</Button>}
				>
					<Scroller>
